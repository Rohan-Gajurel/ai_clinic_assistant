...
@section('title')
    <title>Permissions - MediNest Admin</title>
@endsection
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1" style="color: var(--secondary-color); font-weight: 600;">Permission Management</h4>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title mb-0">
            <i class="bi bi-key me-2" style="color: var(--primary-color);"></i>All Permissions
        </h5>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle d-flex align-items-center justify-content-center me-3" 
                                    ...
                                    <i class="bi bi-key" style="color: var(--primary-color);"></i>
                                </div>
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this permission?');" class="d-inline">
                                @csrf
                                @method('DELETE')
    ...
    <div class="card-footer bg-transparent d-flex justify-content-between align-items-center">
        <span class="text-muted">Showing {{ count($permissions) }} permissions</span>
    </div>
</div>
