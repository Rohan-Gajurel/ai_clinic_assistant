...
@section('title')
    <title>Edit Sample - TeleMed Admin</title>
@endsection
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 fw-semibold">Edit Sample</h4>
    ...
    <div class="col-lg-12">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="{{ route('lab-sample.update', $sample->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-plus-lg me-1"></i>Update Sample
                    </button>
