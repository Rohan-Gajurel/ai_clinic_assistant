...
@section('title')
    <title>Edit Bill - TeleMed Admin</title>
@endsection
...
<div @class(['d-flex', 'justify-content-between', 'align-items-center', 'mb-4'])>
    <div>
        <h4 @class(['mb-1', 'fw-semibold'])>Edit Bill</h4>
                ...
                <form action="{{ route('bills.update', $bill->id) }}" method="POST" id="billForm">
                    ...
                    <div @class(['row'])>
                        ...
                        <div @class(['col-md-6', 'mb-3'])>
                            ...
                            <input type="text" @class(['form-control']) value="{{ $bill->created_at->format('d M, Y') }}" readonly>
                        </div>
                    </div>
                        ...
                        <div @class(['card-body'])>
                            <div @class(['row'])>
                                <div @class(['col-md-4', 'mb-3'])>
                                    ...
                                    <input type="text" name="patient_name" @class(['form-control']) value="{{ old('patient_name', $bill->patient->full_name) }}" readonly>
                                </div>
                                <div @class(['col-md-4', 'mb-3'])>
                                    <label @class(['form-label'])>Age</label>
                                    <input type="text" name="patient_age" @class(['form-control']) value="{{ old('patient_age', $bill->patient->age) }}" readonly>
                                </div>
                                <div @class(['col-md-4', 'mb-3'])>
                                    <label @class(['form-label'])>Gender</label>
                                    <input type="text" name="patient_gender" @class(['form-control']) value="{{ old('patient_gender', $bill->patient->gender) }}" readonly>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody id="itemsBody">
                                        ...
                                        <tr class="item-row">
                                            ...
                                            <td class="position-relative">
                                                <input type="text" class="form-control form-control-sm service-search" placeholder="Type to search..." autocomplete="off" value="{{ $item->service_name }}" readonly>
                                                <input type="hidden" name="items[{{ $index }}][service_id]" class="service-id" value="{{ $item->service_id }}">
                                                <input type="hidden" name="items[{{ $index }}][service_name]" class="service-name" value="{{ $item->service_name }}">
                                            ...
                                            <td>
                                                <input type="number" name="items[{{ $index }}][quantity]" class="form-control form-control-sm qty-input" value="{{ $item->quantity }}" min="1" required>        
                                            </td>
                                            <td>
                                                <input type="number" name="items[{{ $index }}][rate]" class="form-control form-control-sm rate-input" step="0.01" min="0" value="{{ $item->rate }}" required>
                                            </td>
                                            <td>
                                                <input type="number" name="items[{{ $index }}][amount]" class="form-control form-control-sm amount-input" step="0.01" value="{{ $item->amount }}" readonly>
                                            </td>
                                            <td>
                                                <input type="number" name="items[{{ $index }}][discount]" class="form-control form-control-sm discount-input" step="0.01" min="0" value="{{ $item->discount }}">
                                            </td>
                                            <td>
                                                <input type="number" name="items[{{ $index }}][net_amount]" class="form-control form-control-sm net-input" step="0.01" value="{{ $item->net_amount }}" readonly>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-outline-danger remove-item" {{ $index == 0 ? 'disabled' : '' }}>
